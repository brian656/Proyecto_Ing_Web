    ...
    <div class="principal">
        ...
        <div class="container">
          ...
          <div class="form-container-registrar">
            <h1 class="title">Buscar material reciclable</h1>
            <form name="login" action="./validar_buscar_1.php" class="form" method="POST">
                
                <div class="container-input">
                    <label for="codigo-casa" 
                    class="label-registrar">Ingrese código de casa
                    </label>
                    <input type="text" 
                    id="codigo-casa"
                    name="codigo-casa" 
