...
<body>
    <div class="principal">
        ...
        <div class="container">
          ...
          <div class="form-container-registrar-2">
            ...
            <form name="login" action="./reciclador_registrar_3.php" class="form" method="POST">
                ...
                <div class="container-table">
                  ...
                  <div class="table-fila">
                    ...
                    <input type="text" name="papel" id="papel" onclick class="celda-size" required>
                    <!--<input type="text" name="" id="" class="celda-size" placeholder="" disabled> -->
                  </div>
                  <div class="table-fila">
                    <p class="celda-size">Cartón</p>
                    <input type="text" name="" id="" class="celda-size" placeholder=<?php echo $_SESSION["precio_carton"]; ?> disabled>
                    <input type="text" name="carton" id="carton" class="celda-size" required>
                  ...
                  <div class="table-fila">
                    ...
                    <input type="text" name="vidrio" id="vidrio" class="celda-size" required>
                    <!--<input type="text" name="" id="" class="celda-size" placeholder="lectura" disabled> -->
                  </div>
                  <div class="table-fila fila-final">
                    ...
                    <input type="text" name="plastico" id="plastico" class="celda-size" required>
                    <!--<input type="text" name="" id="" class="celda-size" placeholder="lectura" disabled> -->
                  </div>
                ...
                <div class="container-boton">
                    ...
                    formnovalidate
                    formaction="./reciclador_registrar_1.php">
    ...
    <script>
      let peso = document.getElementById("papel").value;
      let precio = <?php echo $_SESSION["precio_papel"]; ?>;
      let total = peso*precio;
      document.getElementById("total").innerHTML = peso;
    </script>
